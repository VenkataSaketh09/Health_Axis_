            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <Button onClick={handleLogin} className="w-full bg-blue-600 hover:bg-blue-800">
                    Sign In
                  </Button>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-6">
                  ...
                  {/* Personal Information */}
                  <div className="space-y-4">
                    <h3 className="text-lg font-semibold text-gray-900">🧍‍♂️ Personal Information</h3>
                  ...
                  {/* Medical Information */}
                  <div className="space-y-4">
                    <h3 className="text-lg font-semibold text-gray-900">🏥 Medical Information <span className="text-sm font-normal text-gray-500">(Optional)</span></h3>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="familyDoctor">Family Doctor / Physician</Label>
                        <Input
                          id="familyDoctor"
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => handleInputChange('healthNotifications', checked)}
                          className="data-[state=checked]:bg-blue-500"
                        />
                        <Label htmlFor="healthNotifications" className="text-sm">
                          I want to receive health notifications and newsletters (Optional)
                        </Label>
                      </div>
                    </div>
                  </div>

                  <Button onClick={handleSignup} className="w-full bg-blue-600 hover:bg-blue-800">
                    Create Account
                  </Button>
